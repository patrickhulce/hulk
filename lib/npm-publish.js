...
const PKGFILES_BIN = path.join(CWD, 'node_modules/.bin/pkgfiles')
...
module.exports = async function npmPublish(options) {
  ...
  console.log('About to publish the following files...')
